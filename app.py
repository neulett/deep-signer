...
home_btn = Generator.ImageButton_Generator('./app/icon/home.png', (35, 35), button_frame, 35, 35, '#2b2b2b', '#2b2b2b')
home_btn.grid(row=0, column=0, padx=15, pady=40)
ttsl_btn = Generator.ImageButton_Generator('./app/icon/sign-language.png', (35, 35), button_frame, 35, 35, '#2b2b2b', '#2b2b2b')
ttsl_btn.grid(row=1, column=0, padx=15, pady=40)
setting_btn = Generator.ImageButton_Generator('./app/icon/settings.png', (35, 35), button_frame, 35, 35, '#2b2b2b', '#2b2b2b')
